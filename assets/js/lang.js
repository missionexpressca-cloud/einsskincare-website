const translations = {
  en: {
    ...
    home: {
      ...
      ctaBrand: "About Eins",
      brandIntroTitle: "A Modern Skincare Brand Built on Effective Formulation",
      brandIntroText: "Eins focuses on ingredient logic, refined textures, and clear product direction. We believe skincare should be effective, honest, and accessible.",
      categoryTitle: "Core Skincare Directions",
      category1Title: "Brightening & Antioxidant Care",
      category1Text: "Designed for dull-looking skin, uneven tone, and daily antioxidant support.",
      category2Title: "Repair & Barrier Support",
      category2Text: "Focused on skin comfort, repair routines, and fragile skin conditions.",
      category3Title: "Firming & Anti-aging Care",
      category3Text: "Targeted at early aging signs, visible lines, and skin resilience.",
      category4Title: "Hydration & Daily Balance",
      category4Text: "Created for moisture support, smoother skin feel, and daily comfort.",
      featuredTitle: "Featured Products",
      featuredText: "Explore selected products from the Eins collection, with reserved image positions ready for future product photography.",
      whyTitle: "Why Eins",
      why1Title: "Ingredient-Focused",
      why1Text: "We prioritize effective formulation logic and meaningful active ingredients.",
      why2Title: "Refined Experience",
      why2Text: "Textures are designed for comfort, usability, and daily skincare habits.",
      why3Title: "Long-Term Value",
      why3Text: "We believe quality skincare should remain accessible and relevant over time.",
      partnerTitle: "Open to Partnership",
      partnerText: "Eins welcomes channel partners, retail collaborators, and international opportunities built on clear product value and long-term brand growth.",
  ...
  zh: {
    ...
    home: {
      ...
      ctaProducts: "查看产品",
      ctaBrand: "了解品牌",
      brandIntroTitle: "一个以有效配方为核心的现代护肤品牌",
      brandIntroText: "Eins 聚焦成分逻辑、质地体验与清晰的产品方向。我们相信，护肤应该有效、真诚，并且更可及。",
      categoryTitle: "核心护肤方向",
      category1Title: "提亮抗氧护理",
      category1Text: "针对暗沉、肤色不均与日常抗氧需求设计。",
      category2Title: "修护与屏障维稳",
      category2Text: "围绕肌肤舒适度、屏障修护与脆弱肤况护理展开。",
      category3Title: "紧致抗老护理",
      category3Text: "针对初老、细纹与肌肤韧性需求进行护理。",
      category4Title: "补水与日常平衡",
      category4Text: "帮助提升保湿度、肤感细腻度与日常舒适状态。",
      featuredTitle: "主推产品",
      featuredText: "精选展示 Eins 产品系列，图片位置已预留，后续可直接替换正式产品实拍图。",
      whyTitle: "为什么选择 Eins",
      why1Title: "重视成分逻辑",
      why1Text: "我们更关注真正有意义的活性成分与配方思路。",
      why2Title: "注重使用体验",
      why2Text: "产品质地围绕舒适度、日常使用习惯与肤感优化设计。",
      why3Title: "长期价值导向",
      why3Text: "我们相信高品质护肤应兼具可持续使用价值。",
      partnerTitle: "开放合作",
      partnerText: "Eins 欢迎渠道合作伙伴、零售合作与国际市场合作机会，共同推动长期品牌成长。",
      partnerButton: "查看合作"
    },
  ...
  fr: {
    ...
    home: {
      ...
      brandIntroTitle: "Une marque de soin moderne fondée sur des formules efficaces",
      brandIntroText: "Eins met l’accent sur la logique des ingrédients, des textures raffinées et une direction produit claire. Nous croyons qu’un soin doit être efficace, honnête et accessible.",
      categoryTitle: "Axes essentiels du soin",
      category1Title: "Éclat et protection antioxydante",
      category1Text: "Pensé pour les peaux ternes, le teint irrégulier et le soutien antioxydant quotidien.",
      category2Title: "Réparation et soutien de la barrière",
      category2Text: "Axé sur le confort cutané, la réparation et les peaux fragilisées.",
      category3Title: "Fermeté et anti-âge",
      category3Text: "Ciblé sur les premiers signes de l’âge, les ridules et la résistance de la peau.",
      category4Title: "Hydratation et équilibre quotidien",
      category4Text: "Conçu pour soutenir l’hydratation, le confort et une peau plus souple au quotidien.",
      featuredTitle: "Produits phares",
      featuredText: "Découvrez une sélection de produits Eins avec des emplacements d’image déjà prévus pour les futures photos officielles.",
      whyTitle: "Pourquoi Eins",
      why1Title: "Axé sur les ingrédients",
      why1Text: "Nous privilégions une logique de formulation efficace et des actifs réellement utiles.",
      why2Title: "Expérience raffinée",
      why2Text: "Les textures sont conçues pour le confort et l’usage quotidien.",
      why3Title: "Valeur durable",
      why3Text: "Nous pensons qu’un soin de qualité doit rester accessible et pertinent dans le temps.",
      partnerTitle: "Ouvert aux partenariats",
      partnerText: "Eins accueille les partenaires de distribution, les collaborations retail et les opportunités internationales fondées sur une valeur produit claire et une croissance durable.",
